                            ...
                            >
                                ...
                                <TableCell className="px-4 py-3">
                                    <Select defaultValue={user.role}
                                            onValueChange={(value: Role) => handleUpdateRole(user.id, value)}>
                                    ...
                                    {currentUser?.id !== user.id ? (
                                        <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                                ...
                                                >
                                                    {deletingUserId === user.id ? "Suppression..." :
                                                        <Trash2 size={18}/>}
                                                </Button>
                                            </AlertDialogTrigger>
                                            <AlertDialogContent>
            ...
            <AlertDialog>
                ...
                <AlertDialogContent>
                    ...
                    <div className="space-y-2">
                        <Input placeholder="Prénom / Nom" value={newUser.username}
                        ...
                        <div className="flex items-center">
                            ...
                            <Button onClick={() => setNewUser({...newUser, password: generatePassword()})}
                                    className="ml-2">
                                <RefreshCcw/>
                            </Button>
                        </div>
